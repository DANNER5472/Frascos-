...
export default function EditPurchaseModal({ 
  ...
  useEffect(() => {
    if (purchase) {
      ...
      setTotalPrice(purchase.total_price.toString());
  ...
  const unitCost = quantity && totalPrice 
    ? (parseFloat(totalPrice) / parseInt(quantity)).toFixed(2) 
    : '0.00';
        ...
        <div className="flex items-start justify-between mb-6">
          <div className="flex items-center gap-3">
            <div style={{
              ...
              <Package style={{ width: '28px', height: '28px', color: '#3b82f6' }} />
            </div>
            <h3 style={{
              fontSize: '1.5rem',
              fontWeight: 'bold',
          ...
          {quantity && totalPrice && (
            <div style={{
              ...
              <p style={{ color: '#93c5fd', fontSize: '0.875rem', margin: 0 }}>
                Costo unitario: <span style={{ fontWeight: 'bold', color: '#60a5fa' }}>Bs. {unitCost}</span> por frasco
              </p>
            </div>
          )}
