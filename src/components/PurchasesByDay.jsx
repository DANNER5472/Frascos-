...
export default function PurchasesByDay({ purchases }) {
  ...
  const calculateDailyStats = () => {
    ...
    purchases.forEach(purchase => {
      ...
      grouped[dateKey].quantity += parseInt(purchase.quantity);
      grouped[dateKey].total += parseFloat(purchase.total_price);
  ...
  if (dailyStats.length === 0) {
    return (
      <div style={{
        ...
        <p style={{ color: '#9ca3af' }}>No hay compras registradas aún</p>
      </div>
    );
  }
